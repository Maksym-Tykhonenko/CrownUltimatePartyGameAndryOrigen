...
////////////////////////////////////////////////////////////////
import PersonalCrownGameCollectionProductScreen from './screens/PersonalCrownGameCollectionProductScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://astounding-supreme-win.space/`;
  const URL_IDENTIFAIRE = `52cLZVg9`;
  ...
  OneSignal.initialize('1e1ce99e-4c91-4068-b772-b2d46ea2c15e');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-03-02T10:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="PersonalCrownGameCollectionProductScreen"
            component={PersonalCrownGameCollectionProductScreen}
